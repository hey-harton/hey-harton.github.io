  ...
  return (
    <html lang="en" className="scroll-smooth overflow-x-hidden">
      ...
      <body className={`${inter.className} bg-[#070709] text-white antialiased flex flex-col min-h-screen relative overflow-x-hidden`}>
        ...
        {/* PERBAIKAN 2: will-change-transform memberi tahu GPU bahwa ini sekadar background mati saat di-scroll */}
        <div className="fixed inset-0 z-0 pointer-events-none will-change-transform">
          
          {/* PERBAIKAN 3: animate-grid-flow diubah menjadi md:animate-grid-flow (Mati di HP, Nyala di PC) */}
          ...
          {/* PERBAIKAN 4: Ukuran blur dikecilkan di HP (300px), Denyut (pulse) DIMATIKAN di HP */}
          ...
          {/* PERBAIKAN 5: Sama seperti di atas, animasi dimatikan di mode mobile */}
