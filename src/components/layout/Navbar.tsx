    ...
    <nav className="relative w-full border-b border-white/10 bg-transparent">
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 py-4 flex justify-between items-center w-full relative">
        ...
        <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 gap-6 lg:gap-8 text-sm font-medium text-gray-300 w-max">
          <Link href="/experience" className="hover:text-brand-blue transition-colors">Pengalaman</Link>
          <Link href="/projects" className="hover:text-brand-blue transition-colors">Proyek</Link>
          <Link href="/datasets" className="hover:text-brand-blue transition-colors">Dataset</Link>
          <Link href="/certifications" className="hover:text-brand-blue transition-colors">Sertifikasi</Link>
        </div>
        ...
        <div className="absolute top-full left-0 w-full bg-[#050505]/98 backdrop-blur-xl border-b border-white/10 shadow-2xl md:hidden z-50 animate-fade-in">
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-8 flex flex-col gap-6">
            <div className="flex flex-col gap-6 text-center font-medium text-gray-300">
              <Link href="/" onClick={() => setIsOpen(false)} className="hover:text-brand-blue transition-colors">Beranda</Link>
              <Link href="/experience" onClick={() => setIsOpen(false)} className="hover:text-brand-blue transition-colors">Pengalaman</Link>
              <Link href="/projects" onClick={() => setIsOpen(false)} className="hover:text-brand-blue transition-colors">Proyek</Link>
              <Link href="/datasets" onClick={() => setIsOpen(false)} className="hover:text-brand-blue transition-colors">Dataset</Link>
              <Link href="/certifications" onClick={() => setIsOpen(false)} className="hover:text-brand-blue transition-colors">Sertifikasi</Link>
            </div>
