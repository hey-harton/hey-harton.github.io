...
export default function ExperienceTimeline() {
  const dynamicExperiences = [
    ...
    },
    {
      ...
      organization: "Enterprise Routing & Switching Lab",
      period: "2024 - 2025",
      ...
      highlights: [
        ...
        "Merancang manajemen bandwidth dan kebijakan firewall ketat untuk pengamanan jalur distribusi data lokal.",
  ...
  return (
    // Padding atas-bawah disesuaikan agar proporsional di layar HP
    <section className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 pt-8 md:pt-16 pb-24 md:pb-32">
      <div className="relative w-full">
        ...
        <div className="absolute left-[25%] top-2 bottom-0 w-px bg-white/10 hidden lg:block -translate-x-[0.5px]"></div>
        
        {/* PERBAIKAN: space-y dihapus dan diganti flex flex-col agar padding bottom dari item tidak dobel */}
